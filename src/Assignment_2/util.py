...
def users_data(spark):
    user_df = spark.read.csv("C:/Users/VinayBoddu/Documents/PysparkRepo/resources/users.csv", header="true", inferSchema="true")
    return user_df


# creating a data frame of transaction.csv file
def transc_data(spark):
    transaction_df = spark.read.csv("C:/Users/VinayBoddu/Documents/PysparkRepo/resources/transactions.csv", header="true", inferSchema="true")
